...
public class SpriteReplacer : MonoBehaviour {
    ...
    public static void ReplaceSprite(SpriteUnit spriteUnit, GameObject bridgeUnit) {
    Sprite newSprite = spriteUnit.Sprite; // The new sprite that you want to use
    bool isVertical = spriteUnit.IsVertical; // To store if the sprite is vertical
        ...
        if (isVertical) {
            ...
            bridgeUnit.transform.rotation = Quaternion.Euler(0, 0, -90 + originalRotationZ); // Rotate the sprite
        }
        else {
