...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        BridgeEvents.StartingGameState += HandleGameStart;
        BridgeEvents.BridgeCollapsingState += HandleGameFailed;
        BridgeEvents.BridgeIsCompletedState += HandleGameSuccess;
    }
